# Store interactive Python shell history in ~/.cache/python/python_history
...
histfile = os.path.join(os.getenv("XDG_CACHE_HOME", os.path.expanduser("~/.cache")), "python/python_history")
try:
