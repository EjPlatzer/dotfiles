...
"
" Example commands:
" `mkdir -p $XDG_CACHE_HOME/vim/swap $XDG_STATE_HOME/vim/{undo,backup} $XDG_CONFIG_HOME/vim` or
"
...
set packpath=$XDG_CONFIG_HOME/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,$XDG_CONFIG_HOME/vim/after
